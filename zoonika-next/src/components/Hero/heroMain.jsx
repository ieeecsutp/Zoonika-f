      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          <h1 className="mb-[0.5rem] text-4xl font-semibold text-gray-900">
            Cuidamos con amor cada <strong className="text-cyan-500 font-bold">PATITA</strong>
          </h1>
        ...
        <div className="relative flex justify-center items-center">
          ...
          {/* Imagen principal */}
          <img src="/img/hero/hero_img.webp" alt="Veterinaria con perro" className="w-64 sm:w-80 object-contain relative z-10" />
        </div>
      </div>
    </section>
  );
